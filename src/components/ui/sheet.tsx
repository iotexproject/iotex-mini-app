...
const SheetContent = React.forwardRef<React.ElementRef<typeof SheetPrimitive.Content>, SheetContentProps>(({ side = 'right', className, children, closeButtonProps, ...props }, ref) => (
  <SheetPortal>
    <SheetOverlay />
